 ...
 */
import { getClient, evaluate, reattach } from '../connection.js';
...
export async function switchTab({ index }) {
  ...
  // Re-attach the CDP client to the new target. Subsequent evaluate() and
  // capture_screenshot() calls run on this target. Note: this does NOT
  // change the visible frontmost tab — TradingView Desktop's Electron build
  // ignores CDP's /json/activate endpoint.
